      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="w-full max-w-sm space-y-6 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Sign in with your Toptal Google account</p>
          </div>
          <button
          ...
          <p className="text-xs text-muted-foreground">Only @toptal.com accounts are allowed</p>
        </div>
      </div>
    );
  }
