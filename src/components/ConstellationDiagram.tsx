...
export default function ConstellationDiagram({ compact = false }: Props) {
  ...
  useEffect(() => {
    ...
    const nodes: DiagramNode[] = [
      {id:"finance",   cat:"finance",  buyer:"CFO",           ll:["Finance","Transformation"],    cx:180,cy:197,rx:78,ry:30,type:"hub",
       info:"<strong>Finance Transformation</strong> (CFO gateway) — Modernizes finance from a cost center to a strategic partner. Five pillars: Strategy & Vision, Performance Management, Process Optimization, Org & Governance, Data & Technology. Draws in Digital Strategy, AI Consulting, Risk & Compliance, and Change Management."},
      {id:"business",  cat:"strategy", buyer:"CEO / COO",     ll:["Business","Transformation"],   cx:180,cy:383,rx:78,ry:30,type:"hub",
       info:"<strong>Business Transformation</strong> (CEO/COO gateway) — Enterprise-wide change to improve performance, competitiveness, and adaptability. Connects to Customer Experience (CX) and all four universal connectors."},
      {id:"growth",    cat:"strategy", buyer:"CSO / CMO",     ll:["Growth Strategy"],              cx:340,cy:105,rx:74,ry:30,type:"hub",
       info:"<strong>Growth Strategy</strong> (CSO/CMO gateway) — Identifies and exploits expansion through market penetration, product development, and diversification. Connects to M&A Consulting, Customer Experience, and Product Strategy."},
      {id:"supply",    cat:"ops",      buyer:"COO",           ll:["Supply Chain &","Procurement"], cx:500,cy:197,rx:78,ry:30,type:"hub",
       info:"<strong>Supply Chain & Procurement</strong> (COO gateway) — Optimizes operations and logistics for resilience, transparency, and efficiency. Pulls in Digital Strategy (IoT/Digital Twins), AI Consulting, Risk & Compliance, Inventory Management, and Sustainability."},
      {id:"perf",      cat:"ops",      buyer:"C-Level / Ops", ll:["Performance","Improvement"],    cx:500,cy:383,rx:78,ry:30,type:"hub",
       info:"<strong>Performance Improvement</strong> (C-Level/Ops gateway) — Drives EBITDA growth, cost reduction, and operational efficiency. Connects to Digital Strategy, Change Management, and AI Consulting to rewire core processes."},
      {id:"workforce", cat:"people",   buyer:"CHRO / CPO",    ll:["Workforce","Transformation"],   cx:340,cy:475,rx:78,ry:30,type:"hub",
       info:"<strong>Workforce Transformation</strong> (CHRO/CPO gateway) — Evolves talent strategy, organizational structure, and culture to meet future business needs. Strongly connected to AI Consulting (reskilling for GenAI), Change Management (adoption), and Digital Strategy (HR tech). Satellites: Org Design and Talent Management."},
      {id:"change",    ll:["Change","Management"],            cx:340,cy:192,rx:62,ry:24,type:"universal",
       info:"<strong>Change Management</strong> (Universal Connector — Human Layer) — 75% of transformations fail due to poor execution. Connects to all six primary hubs, bridging strategy and sustained execution. Especially critical for Workforce Transformation."},
      {id:"digital",   ll:["Digital Strategy"],               cx:435,cy:283,rx:62,ry:24,type:"universal",
       info:"<strong>Digital Strategy</strong> (Universal Connector — Architecture Layer) — The technology roadmap for every transformation: real-time data, automation, IoT, and platform modernization. Connects to all six primary hubs."},
      {id:"ai",        ll:["AI Consulting"],                  cx:340,cy:388,rx:62,ry:24,type:"universal",
       info:"<strong>AI Consulting</strong> (Universal Connector — Intelligence Layer) — Drives automation and advantage through predictive analytics and generative AI. Especially critical for Workforce (reskilling for GenAI) and Finance (predictive decisioning)."},
      ...
      {id:"product",   ll:["Product","Strategy"],             cx:255,cy:57, rx:52,ry:21,type:"secondary",
       info:"<strong>Product Strategy</strong> — Aligns growth aspirations with product development and innovation roadmaps. A direct enabler of Growth Strategy."},
      {id:"mna",       ll:["M&A","Consulting"],               cx:425,cy:57, rx:52,ry:21,type:"secondary",
       info:"<strong>M&A Consulting</strong> — Pursues inorganic growth through target identification, due diligence, and post-merger integration. Orbits both Growth Strategy and Finance Transformation."},
      {id:"inventory", ll:["Inventory","Management"],         cx:580,cy:143,rx:52,ry:21,type:"secondary",
       info:"<strong>Inventory Management</strong> — A tactical drill-down within Supply Chain to optimize stock levels, reduce carrying costs, and ensure supply continuity."},
      {id:"sustain",   ll:["Sustainability"],                 cx:580,cy:258,rx:52,ry:21,type:"secondary",
       info:"<strong>Sustainability Consulting</strong> — Aligns logistics and operations with decarbonization goals and ESG mandates. Connected directly to Supply Chain & Procurement."},
      {id:"cx",        ll:["Customer","Experience"],          cx:105,cy:440,rx:52,ry:21,type:"secondary",
       info:"<strong>Customer Experience (CX)</strong> — Uses seamless digital experiences and personalization as a market differentiator. Bridges Growth Strategy and Business Transformation."},
    ...
    const edges: DiagramEdge[] = [
      ...
      {a:"ai",     b:"workforce", s:"u"},
      {a:"risk",   b:"finance",   s:"u"},{a:"risk",   b:"business",  s:"u"},
      {a:"risk",   b:"supply",    s:"u"},{a:"risk",   b:"growth",    s:"u"},
      {a:"risk",   b:"workforce", s:"u"},
      {a:"growth",   b:"product",   s:"p"},{a:"growth",   b:"mna",       s:"p"},
      {a:"growth",   b:"cx",        s:"p"},
      {a:"finance",  b:"mna",       s:"p"},
      {a:"business", b:"cx",        s:"p"},
