      ...
      <div className="w-full max-w-md mx-4">
        <div className="bg-card rounded-xl shadow-lg p-8 border border-border">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-semibold text-foreground">M&E Platform Maturity</h1>
            <p className="text-muted-foreground text-sm mt-1">Diagnostic Assessment</p>
          </div>
